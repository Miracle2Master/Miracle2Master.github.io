...
![img](img/1779105099410-201.png)

放行以后，由于抛出的是**消息转换异常**，因此Spring会自动返回`reject`，所以消息依然会被删除：

![img](img/1779105099410-202.png)
...
![img](img/1779105099411-211.png)

当然，也可以直接使用课前资料提供好的插件：

![img](img/1779105099411-212.png)
...
![img](img/1779105099411-214.jpeg)
