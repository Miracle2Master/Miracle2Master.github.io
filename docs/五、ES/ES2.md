...
![img](img/1783426307081-4.png)

当你输入的搜索条件不是词条，而是短语时，由于不做分词，你反而搜索不到：

![img](img/1783426307081-5.png)
...
![img](img/1783426307081-16.png)

另一个是`QueryBuilders`，其中包含了我们学习过的各种**叶子查询**、**复合查询**等：

![img](img/1783426307081-17.png)
...
![img](img/1783426307081-23.png)

### 3.1.2.带条件聚合

默认情况下，Bucket聚合是对索引库的所有文档做聚合，例如我们统计商品中所有的品牌，结果如下：

![img](img/1783426307081-24.png)
...
![img](img/1783426307081-25.png)

另外，我们还可以让聚合按照每个品牌的价格平均值排序：

![img](img/1783426307081-26.png)
...
![img](img/1783426307081-27.png)

聚合结果与搜索文档同一级别，因此需要单独获取和解析。具体解析语法如下：

![img](img/1783426307081-28.png)
...
![img](img/1783426307081-30.png)

## 4.2.过滤条件聚合

搜索页面的过滤项目前是写死的：

![img](img/1783426307081-31.png)
...
![img](img/1783426307081-32.png)

由于采用的是POST请求，所以参数在请求体中：

![img](img/1783426307081-33.png)
