...
![img](img/1784776176452-1.png)

这种模式在大多数情况下（99%）并不会有什么问题，不过在极端情况下，特别是多线程并发访问AT模式的分布式事务时，有可能出现脏写问题，如图：

![img](img/1784776176452-2.png)

解决思路就是引入了全局锁的概念。在释放DB锁之前，先拿到全局锁。避免同一时刻有另外一个事务来操作当前数据。

![img](img/1784776176452-3.png)

具体可以参考官方文档：

https://seata.io/zh-cn/docs/dev/mode/at-mode.html

![image-20260723112519287](img/image-20260723112519287.png)
...
![img](img/1784776176453-11.png)

默认所有的服务和配置都属于这个`namespace`，当然我们也可以自己创建新的`namespace`：

![img](img/1784776176453-12.png)

然后填写表单：

![img](img/1784776176453-13.png)

添加完成后，可以在页面看到我们新建的`namespace`，并且Nacos为我们自动生成了一个命名空间id：

![img](img/1784776176453-14.png)

我们切换到配置列表页，你会发现`dev`这个命名空间下没有任何配置：

![img](img/1784776176453-15.png)

因为之前我们添加的所有配置都在`public`下：

![img](img/1784776176453-16.png)
...
![img](img/1784776176453-17.png)

而其它服务则出现在`public`下：

![img](img/1784776176453-18.png)

此时访问`http://localhost:8082/doc.html`，基于`swagger`做测试：

![img](img/1784776176453-19.png)

会发现查询结果中缺少商品的最新价格信息。

我们查看服务运行日志：

![img](img/1784776176453-20.png)
...
![img](img/1784776176453-22.png)

查看nacos控制台，会发现默认情况下所有服务的集群都是default：

![img](img/1784776176453-23.png)
...
![img](img/1784776176453-24.png)

再次查看nacos：

![img](img/1784776176453-25.png)
...
![img](img/1784776176453-26.png)

我们可以用idea打开查看一下：

![img](img/1784776176453-27.png)
...
![image-20260724150344160](img/image-20260724150344160.png)
...
![img](img/1784776176453-41.png)

默认的实现是`RoundRobinLoadBalancer`，即**轮询**负载均衡器。负载均衡器的核心逻辑如下：

![img](img/1784776176453-42.png)
...
![img](img/1784776176454-49.png)

DEBUG重启后测试，会发现负载均衡器的类型确实切换成功：

![img](img/1784776176454-50.png)
...
![img](img/1784776176454-54.png)

可以看到原本是3个实例，经过筛选后还剩下2个实例。

查看Debug控制台：

![img](img/1784776176454-55.png)
...
![img](img/1784776176454-56.png)

那么问题来了， 这个权重是怎么配的呢？

我们打开nacos控制台，进入`item-service`的服务详情页，可以看到每个实例后面都有一个**编辑**按钮：

![img](img/1784776176454-57.png)

点击，可以看到一个编辑表单：

![img](img/1784776176454-58.png)

我们将这里的权重修改为5：

![img](img/1784776176454-59.png)
...
![img](img/1784776176454-60.jpeg)

两者的优缺点如下：

![img](img/1784776176454-61.png)
